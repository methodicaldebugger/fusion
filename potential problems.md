...
Use a minimal core + downloadable toolchains + optional integrations + cloud builds. Local/cloud idea is very strong here. There should be a small default Fusion installation. Small enough to install normally. Then download plugins for other languages.
